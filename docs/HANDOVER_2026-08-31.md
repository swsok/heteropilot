...
> **HISTORICAL — superseded 2026-09-04 by `docs/HANDOVER.md`.** Kept as the record
> of a single move (→ NPU node) and of what was believed at `3d59035`. Do not read
> it as current status: it predates the tiered-profile work, the D22 envelope
> retraction, the D23 livelock and the ScenarioLab split, and its "pytest 284
> passed" is four cycles out of date.
>
> Written 2026-08-31 at `main` = `3d59035`, after PRs #17–#22. It is **node-agnostic**: every open item below says which machine it
